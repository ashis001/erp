...
export default function CreditPage() {
  ...
  useEffect(() => {
    ...
    // Sort by status: active first, then others, completed last
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'active':
        return <Badge variant="default" className="bg-orange-500">Active</Badge>;
      case 'completed':
    ...
    <div className="flex h-full flex-col">
      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-6">
        <div className="space-y-6">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Credit Sales Management</h1>
