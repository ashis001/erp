...
import ItemManagement from '@/components/dashboard/superadmin/item-management';
      ...
      <div className="flex h-full flex-col">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6">
          <div className="text-center py-8">
            <p className="text-muted-foreground">Access denied. Only superadmins can manage items.</p>
          </div>
        </main>
      </div>
    );
